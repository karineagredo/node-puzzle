 ...
 */
function WordCounterSecondApproach() {
...
inherits(WordCounterSecondApproach, Transform);

WordCounterSecondApproach.prototype._transform = function (chunk, enc, next) {
...
WordCounterSecondApproach.prototype._flush = function (cb) {
  this.push({ words, lines });
  cb();
};

module.exports = WordCounterSecondApproach;
